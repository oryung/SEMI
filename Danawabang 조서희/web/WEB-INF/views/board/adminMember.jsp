...
<!--!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!상단!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!! -->
	<div id="main-container" class="container">
		...
		<div class="row" id="middleCategories">
			...
			<div onclick="location.href='관리자_회원관리(AdminMemberManage).html';" class="col"
			...
			<div class="col">
				<div onclick="location.href='#';"  class="dropdown" data-toggle="dropdown"
					...
					설정
					<div class="dropdown-menu">
						<a class="dropdown-item" onclick="location.href='관리자_설정(AdminSetting).html'">관리자정보수정</a>
						<a class="dropdown-item" onclick="location.href='관리자_탈퇴(AdminWithdraw).html'">관리자탈퇴</a>
					</div>
				</div>
			</div>
			<!-- 중단 카테고리 여백 -->
		...
		<form>
			<table class="table" style="width: 720px; margin-left: 220px; margin-top: 10px; text-align: center;">
				...
				<tbody>
					<tr class="">
						<th scope="row"><input type="checkbox" class="check" name="agree" onclick="selectOne();"></td>
						<td>Mark</td>
						<td>Otto</td>
						<td>관리자</td>
						<td onclick="location.href='회원 관리_관리자 상세 정보.html';" style="cursor:pointer;"><i class="bi bi-search"></i></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td>Otto</td>
						<td>회원</td>
						<td onclick="location.href='회원 관리_회원 상세 정보.html';" style="cursor:pointer;"><i class="bi bi-search"></i></td>
					</tr>
					<tr>
						<th scope="row"><input type="checkbox" class="check" name="agree" onclick="selectOne();"></th>
						<td>Mark</td>
		...
		<div class="row" style="height: 50px;">
			...
			<div class="col" style="left: 37%; width: 70%;">
				<!-- 권한 수정 버튼 -->
				<button class="button1" onclick="location.href='.html'">권한 수정</button>
				<!-- 회원 탈퇴 버튼 -->
