...
<body style="font-family: 'Nanum Gothic', sans-serif;">
	...
	<div id="main-container" class="container">
		...
		<nav aria-label="Page navigation example" class="pagination justify-content-center page-item">
         <!-- 맨 처음으로 -->
         <button class="page-link" onclick="location.href='<%=request.getContextPath() %>/boardNotice.bo?currentPage=1'"> &lt;&lt; </button>
         <!-- 이전 페이지로 -->
         ...
         <!-- 맨 끝으로 -->
         <button class="page-link" onclick="location.href='<%=request.getContextPath() %>/boardNotice.bo?currentPage=<%= maxPage %>'"> &gt;&gt;</button>
      </nav>
		<!-- 행 사이 빈공간-->
