		...
		<div class="row"
			...
			<div class="col-6">
				<form onsubmit="return enroll();">
					...
					아이디<br>
					<input type="text" id="id" class="form-control" placeholder="아이디" style="display: inline;">
					<button type="button" class="button1" style="margin-left: 20px;">중복확인</button><br>
					비밀번호<br> 
					...
					<input type="password" id="pw2" class="form-control" placeholder="비밀번호 확인" style="display: inline" onblur="checkPw();">

					<!-- 비밀번호 동일한지 알림 -->
					<span id="check" style="font-size: 15px; font-weight: normal;">&nbsp;</span><br>

					이메일<br> <input type="text" id="email" class="form-control"	placeholder="이메일">
