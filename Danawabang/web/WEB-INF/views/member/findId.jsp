...
<body style="font-family: 'Nanum Gothic', sans-serif;">
	...
	<div id="main-container" class="container">
			...
			<div class="row" style="text-align: center;">
				...
				<div class="col-5">
					...
					<form onsubmit="return findId();">
						...
						<!-- 정보 입력란 -->
						<input type="text" class="info form-control" placeholder="이름" id="name">
						<br>
						...
						<div class="row">
							<div class="col" style="font-size: 18px; font-weight: bold;">
								<a href="" class="findPw" style="text-decoration: none;">비밀번호
									찾기</a>
							</div>
						</div>
		...
		<!--!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!하단!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!! -->
		<!-- 행 사이 빈공간-->
		<div class="row" style="margin-top: 100px; margin-bottom: 70px;"></div>
