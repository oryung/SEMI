...
<!--!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!상단!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!! -->
			...
			<div  class="col">
				<div onclick="location.href='#';" class="dropdown" data-toggle="dropdown"
					...
					<div class="dropdown-menu">
						<a class="dropdown-item" onclick="location.href='게시판 관리_스토어.html'">스토어</a>
						<a class="dropdown-item" onclick="location.href='게시판 관리_셀프가이드.html'">셀프가이드</a>
						<a class="dropdown-item" onclick="location.href='게시판 관리_프로모션.html'">프로모션</a>
						<a class="dropdown-item" onclick="location.href='게시판 관리_공지사항.html'">공지사항</a>
						<a class="dropdown-item" onclick="location.href='게시판 관리_FAQ.html'">FAQ</a>
					</div>
				</div>
			</div>
			<div class="col">
	...
	<!--!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!! 본문 (회원 상세 정보) !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!! -->
         ...
         <div class="row">
            ...
            <table class="table" style="width: 720px; margin-left: 220px; margin-top: 10px; text-align: center;">
				...
				<tr>
					...
					<td width="37%">최성환</td>
					<th scope="col">아이디</th>
					<td width="37%">test111</td>
				</tr>
				<tr>
					<th scope="col">이메일</th>
					<td>sss1j@naver.com	</td>
					<th scope="col">연락처</th>
					<td>01046925206</td>
				</tr>
				<tr>
					<th scope="col">주소</th>
					<td>서울 동작구 국사봉1길 3,2층(07041)</td>
					<th scope="col">가입일</th>
					<td>2021-05-19</td>
				</tr>
				</tbody>
		...
		<div class="row" style="height: 50px;">
			...
			<button class="button1" onclick="location.href='회원 관리.html'">돌아가기</button>
			</div>
			<!-- 삭제 버튼 -->
			<div class="col"
