		...
		<!-- 행 사이 빈공간-->
			...
			<div class="row">
				...
				<div class="col-5"
					...
					<input class="form-control" type="text" id="adminCode" placeholder="관리자코드"
						style="color: rgb(94, 94, 94); font-size: 14px; line-height: 200%; width: 70%;"><br>
						<button type="button" class="button1" onclick="location.href='마이페이지-설정-회원정보수정.html';" style="width: 100px; margin-left:20px;">돌아가기</button>
