			...
			<table class="table" style="width: 720px; margin-left: 220px; margin-top: 10px; text-align: center;">
				<tbody>
						...
						if(optionList.size() == 2) { %>
							 <% for(int i = 0; i < 2; i++) {%>
								<tr>
									...
									<td><input type="text"  id="option<%= i + 1 %>ExtraPrice" name="optionsExtraPrice" value="<%= optionList.get(i).getProductOptionOriginPrice() %>" class="form-control" ></td>
								</tr>
							 <% } %>
							 	<tr>
									...
									<td><input type="text"  id="option3ExtraPrice" name="optionsExtraPrice" value=0 class="form-control" ></td>
								</tr>
						<% } else { %>
						 	<% for(int i = 0; i < 2; i++) {%>
								<tr>
						...
						<tr>
							...
							<td><input type="text"  id="option1Amount" name="optionsAmount" value="<%= optionList.get(0).getProductOptionAmount() %>" class="form-control" ></td>
						...
						<tr>
							...
							<td><input type="text"  id="option2Amount" name="optionsAmount" value="<%= optionList.get(1).getProductOptionAmount() %>" class="form-control"  ></td>
						...
						<tr>
							...
							<td><input type="text"  id="option3Amount" name="optionsAmount" value="<%= optionList.size() == 2 ? "0" : optionList.get(2).getProductOptionAmount() %>" class="form-control" ></td>
							<th scope="col" style="vertical-align: middle;">할인율</th>
							<td><input type="text"  id="discount" name="discount" class="form-control" value="<%= p.getProductDiscountRate() %>" ></td>
						</tr>
