 ...
 * Generated at: 2021-07-05 10:27:01 UTC
...
public final class adminMember_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/WEB-INF/views/member/../common/adminMiddleCategory.jsp", Long.valueOf(1625474927215L));
  }
 ...
 if(loginUser == null) { 
      ...
      out.write("					class=\"\">회원 리스트</div>\r\n");
      out.write("			</div>\r\n");
      out.write("		</div>\r\n");
      out.write("		\r\n");
      out.write("		<form action=\"\" id=\"adminMemberForm\">\r\n");
      out.write("		<!-- 테이블  -->\r\n");
      out.write("		<div class=\"row\">\r\n");
      out.write("			<table class=\"table\" id=\"table\" style=\"width: 720px; margin-left: 220px; margin-top: 10px; text-align: center;\">\r\n");
      out.write("				<thead>\r\n");
      out.write("					<tr>\r\n");
      out.write("						<th scope=\"col\"><input type=\"checkbox\" id=\"all\" onclick=\"selectAll();\"></th>\r\n");
 ...
 for(Member m : list) { 
      ...
      out.write("</td>\r\n");
      out.write("							<td>");
      out.print( m.getIsAdmin() );
      out.write("</td>\r\n");
      out.write("							<td onclick=\"location.href='adminMemberDetail.me?userId=");
      out.print(m.getId() );
      out.write("'\" style=\"cursor:pointer;\"><i class=\"bi bi-search\"></i></td>\r\n");
      out.write("						</tr>\r\n");
      out.write("						");
 memberCount++; 
      out.write("<!-- 한페이지에 나온 게시글의 개수 파악 -->\r\n");
      out.write("					");
 } 
      out.write("\r\n");
      out.write("				</tbody>\r\n");
      out.write("			</table>\r\n");
      out.write("		</div>\r\n");
      out.write("		<!-- 체크된 회원의 아이디 저장 -->\r\n");
      out.write("		<input type=\"hidden\" id=\"checkMembers\" name=\"checkMembers\" value=\"\">\r\n");
      out.write("		<!-- 어떤 권한으로 바꿀지 저장해놓기 -->\r\n");
      ...
      out.write("			<!-- 검색창  -->\r\n");
      out.write("			<div class=\"col-3\" style=\"left: 20%;\">\r\n");
      ...
      out.write("				<!-- 권한 수정 버튼 -->\r\n");
      out.write("				<button class=\"button1\" onclick=\"changeAccess();\">권한 수정</button>\r\n");
      out.write("				<!-- 회원 탈퇴 버튼 -->\r\n");
      out.write("				<button class=\"button1\" onclick=\"selectDeleteMember();\">회원 탈퇴</button>\r\n");
      out.write("				<!--  관리자 등록 버튼 눌렀을 때 회원가입 폼이 뜨게 함 -->\r\n");
      out.write("			</div>\r\n");
      out.write("		</div>\r\n");
      out.write("		</form>	\r\n");
      out.write("\r\n");
      ...
      out.print(request.getContextPath() );
      out.write("/adminMember.me?currentPage=1'\" id=\"bebeforeBtn\"> &lt;&lt; </button>\r\n");
      out.write("         <!-- 이전 페이지로 -->\r\n");
      out.write("         <button class=\"page-link\" onclick=\"location.href='");
      out.print(request.getContextPath() );
      out.write("/adminMember.me?currentPage=");
 ...
 for(int p = startPage; p <=endPage; p++) { 
      ...
      out.write("		}\r\n");
      out.write("		\r\n");
      out.write("		// 체크박스를 이용한 여러 회원 한번에 탈퇴 시키기\r\n");
      out.write("		 function selectDeleteMember(){\r\n");
      out.write("			var checkList = document.getElementsByName('check');\r\n");
      out.write("			var checkMemberId = '';\r\n");
      out.write("			\r\n");
      out.write("			// 체크박스 선택된 회원의 아이디 목록 저장하기 \r\n");
      out.write("			for(var i = 0 ; i < ");
      out.print( memberCount );
      out.write(" ; i++) {\r\n");
      out.write("				if(checkList[i].checked) {\r\n");
      out.write("					checkMemberId += checkList[i].parentNode.nextSibling.nextSibling.nextSibling.nextSibling.innerHTML + \",\";\r\n");
      out.write("				}\r\n");
      out.write("			}\r\n");
      out.write("			document.getElementById('checkMembers').value = checkMemberId;\r\n");
      out.write("			\r\n");
      out.write("			if(checkMemberId == '' || checkMemberId.length == 0) {\r\n");
      out.write("				alert(\"회원을 먼저 체크해주세요\");\r\n");
      out.write("				return 0;\r\n");
      out.write("			}\r\n");
      out.write("			\r\n");
      out.write("			\r\n");
      ...
      out.write("				$('#adminMemberForm').attr('action', '");
      out.print( request.getContextPath() );
      out.write("/deleteMembers.me');\r\n");
      out.write("				$('#adminMemberForm').submit();\r\n");
      out.write("				\r\n");
      ...
      out.write("		\r\n");
      out.write("		// 권한 수정하기\r\n");
      out.write("		function changeAccess() {\r\n");
      out.write("			var checkList = document.getElementsByName('check');\r\n");
      out.write("			var checkMemberId = '';\r\n");
      out.write("			\r\n");
      out.write("			for(var i = 0 ; i < ");
      ...
      out.write("				var result = window.prompt(\"권한을 수정하시겠습니까?(ADMIN, USER)\");\r\n");
      out.write("				if(result == null) {\r\n");
      out.write("					return 0;\r\n");
      out.write("				}\r\n");
      out.write("				result = result.toUpperCase();\r\n");
      out.write("				if(result == 'ADMIN' || result == 'USER') {\r\n");
      out.write("					break;\r\n");
      out.write("				}	\r\n");
      out.write("			}\r\n");
      out.write("			// 어떤 권한으로 변경할 것인지 값을 받아 저장하기\r\n");
      out.write("			document.getElementById('access').value = result;\r\n");
      out.write("			\r\n");
      out.write("			result = window.prompt(\"권한수정하시려면 관리자 코드를 입력하십시오\");\r\n");
      out.write("			if(result == 'realadmin'){\r\n");
      out.write("				alert(\"권한수정 완료했습니다.\");\r\n");
      out.write("				$('#adminMemberForm').attr('action', '");
      out.print( request.getContextPath() );
      out.write("/changeAccess.me');\r\n");
      out.write("				$('#adminMemberForm').submit();\r\n");
      out.write("			} else if (result == null){\r\n");
      out.write("				\r\n");
      out.write("			} else {\r\n");
