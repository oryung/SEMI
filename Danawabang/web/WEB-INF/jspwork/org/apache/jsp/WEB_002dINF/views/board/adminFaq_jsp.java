 ...
 * Generated at: 2021-07-04 13:48:40 UTC
...
public final class adminFaq_jsp extends org.apache.jasper.runtime.HttpJspBase
 ...
 if(loginUser == null) { 
      ...
      out.write("					class=\"\">FAQ 게시글 리스트</div>\r\n");
      out.write("			</div>\r\n");
      out.write("		</div>\r\n");
      out.write("		\r\n");
      out.write("		<!-- 테이블  -->\r\n");
      out.write("		<form action=\"\" id=\"adminFaqForm\">\r\n");
      ...
      out.write("							<th scope=\"col\" style=\"width: 140px;\">카테고리</th>\r\n");
 ...
 for(Board b : list) { 
      ...
      out.print(request.getContextPath());
      out.write("/adminFaqDetail.me?bId=' + ");
      out.print( b.getBoardId() );
      out.write("\"\r\n");
 ...
 if(loginUser.getIsAdmin().equals("ADMIN")){ 
      ...
      out.print(request.getContextPath() );
      out.write("/adminFaqEnrollForm.me';\">등록</button>\r\n");
      out.write("				<!-- 삭제 버튼 -->\r\n");
      ...
      out.print(request.getContextPath() );
      out.write("/adminFaq.me?currentPage=1'\" id=\"bebeforeBtn\"> &lt;&lt; </button>\r\n");
      out.write("			<!-- 이전 페이지로 -->\r\n");
      out.write("			<button class=\"page-link\" onclick=\"location.href='");
      out.print(request.getContextPath() );
      out.write("/adminFaq.me?currentPage=");
 ...
 for(int p = startPage; p <=endPage; p++) { 
      ...
      out.write("				$('#adminFaqForm').attr('action', '");
      out.print( request.getContextPath() );
      out.write("/deleteFaqs.me');\r\n");
      out.write("				$('#adminFaqForm').submit();			\r\n");
      out.write("			} else {\r\n");
