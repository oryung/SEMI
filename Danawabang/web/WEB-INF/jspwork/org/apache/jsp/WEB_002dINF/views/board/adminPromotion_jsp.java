 ...
 * Generated at: 2021-07-05 03:56:49 UTC
...
public final class adminPromotion_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
	...
	int checkBoardCount = 0;
      ...
      out.write("<title>관리자_게시판관리_프로모션</title>\r\n");
 ...
 if(loginUser == null) { 
      ...
      out.write("					class=\"\">프로모션 게시글 리스트</div>\r\n");
      out.write("			</div>\r\n");
      out.write("		</div>\r\n");
      out.write("		\r\n");
      out.write("		<!-- 테이블  -->\r\n");
      out.write("		<form action=\"\" id=\"adminPromotionForm\">\r\n");
      ...
      out.write("							<th scope=\"col\" style=\"width: 70px;\">글번호</th>\r\n");
      out.write("							<th scope=\"col\" style=\"width: 390px;\">제목</th>\r\n");
      out.write("							<th scope=\"col\" style=\"width: 140px;\">작성자</th>\r\n");
      out.write("							<th scope=\"col\" style=\"width: 90px;\">상세보기</th>\r\n");
      out.write("						</tr>\r\n");
      out.write("					</thead>\r\n");
      out.write("					");
 if(bList.isEmpty()) {
 ...
 for(Board b : bList) { 
      out.write("\r\n");
      out.write("						<tr>\r\n");
      out.write("							<td><input type=\"checkbox\" class=\"check\" name=\"check\"\r\n");
      ...
      out.print(request.getContextPath());
      out.write("/adminPromotionDetail.bo?bId=' + ");
      out.print( b.getBoardId() );
      out.write("\"\r\n");
 ...
 if(loginUser.getIsAdmin().equals("ADMIN")){ 
      ...
      out.print(request.getContextPath() );
      out.write("/adminPromotionEnrollForm.bo';\">등록</button>\r\n");
      out.write("				<!-- 삭제 버튼 -->\r\n");
      ...
      out.print(request.getContextPath() );
      out.write("/adminPromotion.bo?currentPage=1'\" id=\"bebeforeBtn\"> &lt;&lt; </button>\r\n");
      out.write("			<!-- 이전 페이지로 -->\r\n");
      out.write("			<button class=\"page-link\" onclick=\"location.href='");
      out.print(request.getContextPath() );
      out.write("/adminPromotion.bo?currentPage=");
 ...
 for(int p = startPage; p <=endPage; p++) { 
      ...
      out.write("				$('#adminPromotionForm').attr('action', '");
      out.print( request.getContextPath() );
      out.write("/deletePromotions.bo');\r\n");
      out.write("				$('#adminPromotionForm').submit();\r\n");
      out.write("				\r\n");
