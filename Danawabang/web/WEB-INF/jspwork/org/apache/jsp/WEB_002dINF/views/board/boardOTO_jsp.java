...
public final class boardOTO_jsp extends org.apache.jasper.runtime.HttpJspBase
 ...
 if(loginUser == null) { 
      ...
      out.write("				<form>\r\n");
      out.write("					<div class=\"row\">\r\n");
      out.write("					<table class=\"table\" id=\"listArea\" style=\"text-align: center; width: 750px;\">\r\n");
      out.write("						<thead>\r\n");
      out.write("							<tr>\r\n");
      out.write("								<th scope=\"col\" style=\"width: 80px;\">글번호</th>\r\n");
      out.write("								<th scope=\"col\" style=\"width: 500px;\">제목</th>\r\n");
      out.write("								<th scope=\"col\" style=\"width: 120px;\">작성자ID</th>\r\n");
 ...
 if (list.isEmpty()) { 
      out.write("\r\n");
      out.write("						<tr>\r\n");
      out.write("							<td colspan=\"4\" style=\"cursor:default;\">조회된 리스트가 없습니다.</td>\r\n");
      out.write("						</tr>\r\n");
      out.write("						");
 } else { 
      out.write("\r\n");
 ...
 checkBoardCount++; 
      ...
      out.write("\r\n");
      out.write("							<tr>\r\n");
      out.write("								<td colspan=\"4\">회원만 등록 및 조회가 가능합니다.</td>\r\n");
      out.write("							</tr>\r\n");
      out.write("						");
 } 
      out.write("\r\n");
      ...
      out.write("	<form action=\"");
      out.print( request.getContextPath() );
      out.write("/boardOTO.bo\" id=\"listForm\" method=\"post\" >\r\n");
      out.write("					\r\n");
 ...
 if(loginUser != null){ 
      ...
      out.write("			<div class=\"col\"><button type=\"button\" class=\"button1\" onclick=\"location.href='");
      out.print( request.getContextPath() );
      out.write("/boardOTOEnroll.bo';\" style=\"margin-left: 600px;\">등록</button></div>\r\n");
      out.write("			");
 } 
      out.write("\r\n");
      out.write("		</div>\r\n");
 ...
 if(loginUser != null){ 
      ...
      out.print(request.getContextPath() );
      out.write("/boardOTO.bo?currentPage=1'\" id=\"bebeforeBtn\"> &lt;&lt; </button>\r\n");
      out.write("			<!-- 이전 페이지로 -->\r\n");
      out.write("			<button class=\"page-link\" onclick=\"location.href='");
      out.print(request.getContextPath() );
      out.write("/boardOTO.bo?currentPage=");
 ...
 for(int p = startPage; p <=endPage; p++) { 
      ...
      out.write("				$('tr').eq(i).children().eq(1).css('text-align', 'left');\r\n");
      out.write("			}\r\n");
      out.write("		});\r\n");
      out.write("		// 조회 리스트 없을때\r\n");
      out.write("		\r\n");
 ...
 if(loginUser != null){ 
      ...
      out.write("	            var writer = $(this).parent().children().eq(2).text();\r\n");
      out.write("	            \r\n");
      out.write("	            if(	writer == \"");
      out.print( loginUser.getId() );
      out.write("\" || \"");
      out.print( loginUser.getIsAdmin() );
      out.write("\" == \"ADMIN\") {\r\n");
      ...
      out.print( request.getContextPath() );
      out.write("/boardOTODetail.bo?bId='+ bId;      \r\n");
      out.write("	               } \r\n");
      out.write("               \r\n");
      out.write("	            } else{\r\n");
      out.write("	            	alert(\"글 작성자만 내용을 볼 수 있습니다.\")\r\n");
      out.write("	            }\r\n");
      out.write("	           \r\n");
      out.write("	         });   \r\n");
      out.write("	      });   \r\n");
