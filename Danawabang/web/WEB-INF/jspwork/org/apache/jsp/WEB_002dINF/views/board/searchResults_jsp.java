 ...
 * Generated at: 2021-07-05 11:40:26 UTC
...
public final class searchResults_jsp extends org.apache.jasper.runtime.HttpJspBase
 ...
 if(loginUser == null) { 
      ...
      out.write("		<!--!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!상단 끝!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!! -->\r\n");
      out.write("		<!-- 행 사이 빈공간-->\r\n");
      out.write("		<div class=\"col-12\" style=\"margin-top: 30px;\"><span style=\"font-size:20px; font-weight: bold;\" >'");
      out.print( sAllWord );
      out.write("'</span>에 대한 검색 결과 <span style=\"color: #11bbff\">");
      out.print( pSearchCount );
 ...
 if(pSearchList.isEmpty()) { 
      ...
      out.write("			<div class=\"col-8 text-center\" style=\"height:300px; top:300px; font-size:30px; font-weight: bold;\">찾으시는 결과가 없네요...</div>\r\n");
 ...
 if(pSearchList.isEmpty() || pList.isEmpty()) { 
      ...
      out.write("		<div style=\"margin-top: 10px; width: 100%; border-bottom: 1px solid #11BBFF; margin-bottom: 15px;\"></div>\r\n");
      out.write("			<div class=\"row\">\r\n");
      out.write("				");
 ...
 int rate =  (int)(Math.ceil(p.getProductDiscountRate()*100)); 
  ...
  if(i == 8) break; 
      ...
      out.write("\r\n");
      out.write("				<pre>\r\n");
      out.write("					<button type=\"button\" style=\"width:250px; margin-left: 100px; font-size: 18px; font-weight: bolder; \"class=\"button1\" id=\"more\">더보기</button>\r\n");
      out.write("				</pre>\r\n");
      out.write("				<div id=\"product8\" style=\"display:none\" >\r\n");
      out.write("				");
