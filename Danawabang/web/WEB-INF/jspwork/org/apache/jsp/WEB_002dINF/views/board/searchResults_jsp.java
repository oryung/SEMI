 ...
 * Generated at: 2021-07-02 15:27:13 UTC
...
public final class searchResults_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/WEB-INF/views/board/../common/top.jsp", Long.valueOf(1625239614871L));
 ...
 int rate =  (int)(Math.ceil(p.getProductDiscountRate()*100)); 
  ...
  if(i == 8) break; 
      ...
      out.write("				");
 for(int i = 8; i < pSearchList.size(); i++) { 
      out.write("\r\n");
      out.write("					");
 Product p = pSearchList.get(i); 
      out.write("\r\n");
 ...
 int rate =  (int)(Math.ceil(p.getProductDiscountRate()*100)); 
      ...
      out.write("			});\r\n");
      out.write("		});\r\n");
      out.write("		// 셀프가이드 상세페이지 이동\r\n");
      out.write("		\r\n");
      out.write("		// 프로모션 상세페이지 이동 \r\n");
      out.write("		\r\n");
      out.write("		// 더보기 클릭\r\n");
      out.write("		//상품 더보기\r\n");
      out.write("		$(function(){\r\n");
      out.write("		");
 if(10 >= pSearchList.size()) { 
      out.write("\r\n");
      out.write("			$('#more').hide();\r\n");
      out.write("		");
 } 
