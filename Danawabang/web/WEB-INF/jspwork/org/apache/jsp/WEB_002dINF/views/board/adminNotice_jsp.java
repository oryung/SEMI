 ...
 * Generated at: 2021-07-05 07:15:36 UTC
...
public final class adminNotice_jsp extends org.apache.jasper.runtime.HttpJspBase
 ...
 if(loginUser == null) { 
      ...
      out.write("					class=\"\">공지사항 게시글 리스트</div>\r\n");
      out.write("			</div>\r\n");
      out.write("		</div>\r\n");
      out.write("		\r\n");
      out.write("		<!-- 테이블  -->\r\n");
      out.write("		<form action=\"\" id=\"adminNoticeForm\">\r\n");
 ...
 int bId =  b.getBoardId(); 
      ...
      out.print( request.getContextPath() );
      out.write("/adminNoticeDetail.bo?bId='+ ");
      out.print( bId );
 ...
 if(loginUser != null && loginUser.getIsAdmin().equals("ADMIN")){ 
      ...
      out.print(request.getContextPath() );
      out.write("/adminNoticeEnroll.bo'\">등록</button>\r\n");
      out.write("				<!-- 삭제 버튼 -->\r\n");
      ...
      out.print(request.getContextPath() );
      out.write("/adminNotice.bo?currentPage=1'\" id=\"bebeforeBtn\"> &lt;&lt; </button>\r\n");
      out.write("         <!-- 이전 페이지로 -->\r\n");
      out.write("         <button class=\"page-link\" onclick=\"location.href='");
      out.print(request.getContextPath() );
      out.write("/adminNotice.bo?currentPage=");
 ...
 if(currentPage == 1) { 
      ...
      out.print( fNListCount );
      out.write("; i++){\r\n");
      out.write("				$('#listArea td').parent().children().eq(6 * i - 4).css({'font-weight' : 'bold'});\r\n");
      out.write("			}\r\n");
      out.write("			");
 } 
      out.write("\r\n");
      ...
      out.write("				$('#adminNoticeForm').attr('action', '");
      out.print( request.getContextPath() );
      out.write("/deleteNotices.bo');\r\n");
      out.write("				$('#adminNoticeForm').submit();			\r\n");
      out.write("			} else {\r\n");
