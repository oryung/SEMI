...
/**
 * Servlet implementation class BoardPromotionServlet
 */
@WebServlet("/boardPromotion.bo")
public class BoardPromotionServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public BoardPromotionServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(bList != null && fList != null) {
			...
			page = "WEB-INF/views/board/boardPromotion.jsp";
		} else {
