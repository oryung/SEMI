...
/**
 * Servlet implementation class AdminSettingFormServlet
 */
@WebServlet(urlPatterns="/adminSettingForm.me", name="AdminSettingFormServlet")
public class AdminSettingFormServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AdminSettingFormServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(result > 0) {
			...
			request.getRequestDispatcher("WEB-INF/views/member/adminSettingForm.jsp").forward(request, response);
