 ...
 */
@WebServlet(urlPatterns="/adminDeleteForm.me", name="AdminDeleteFormServlet")
public class AdminDeleteFormServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(result > 0) {
			...
			request.getRequestDispatcher("WEB-INF/views/member/adminWithdraw.jsp").forward(request, response);
