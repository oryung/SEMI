 ...
 */
@WebServlet("/mySetting.me")
public class MySettingServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public MySettingServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		Member member = new Member(0, myName, myId, myPwd, myEmail, myPhone, myAddress, null, null, null, null);
		...
		if(result > 0) {
			...
			request.getRequestDispatcher("WEB-INF/views/member/mySetting.jsp").forward(request, response);
		} else {
