...
public class Member {
	...
	public Member(int memberNum, String name, String id, String pwd, String email, String phone, String address,
	...
	public Member(int memberNum, String name, String id, String pwd, String email) {
		this.memberNum = memberNum;
		this.name = name;
		this.id = id;
		this.pwd = pwd;
	...
	public String toString() {
		return "Member [memberNum=" + memberNum + ", name=" + name + ", id=" + id + ", pwd=" + pwd + ", email=" + email
