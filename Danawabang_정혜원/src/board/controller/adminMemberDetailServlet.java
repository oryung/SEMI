...
public class adminMemberDetailServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(m.getIsAdmin().equals("USER")) {
			request.getRequestDispatcher("WEB-INF/views/board/adminMemberDetailM.jsp").forward(request, response);						
		} else {
			request.getRequestDispatcher("WEB-INF/views/board/adminMemberDetailA.jsp").forward(request, response);			
		}
	}
