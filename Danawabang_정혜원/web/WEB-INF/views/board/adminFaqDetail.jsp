	...
	<div id="main-container" class="container">
		...
		<div class="row" id="middleCategories">
			...
			<div onclick="location.href='주문 관리.html';" class="col"
				...
				주문 관리</div>
			<div class="col">
				<div onclick="location.href='#';" class="dropdown"
					data-toggle="dropdown"
					style="text-align: center; vertical-align: middle; text-decoration: none; cursor: pointer; font-size: 20px; font-weight: bold;">
					게시판 관리
					<div class="dropdown-menu">
						<a class="dropdown-item"
							onclick="location.href='관리자_게시판관리_스토어(AdminBoardStore).html'">스토어</a>
						<a class="dropdown-item"
							onclick="location.href='관리자_게시판관리_셀프가이드(AdminBoardSelfGuide).html'">셀프가이드</a>
						<a class="dropdown-item"
							onclick="location.href='관리자_게시판관리_프로모션(AdminBoardPromotion).html'">프로모션</a>
						<a class="dropdown-item"
							onclick="location.href='관리자_게시판관리_공지사항(AdminBoardNotice).html'">공지사항</a>
						<a class="dropdown-item"
							onclick="location.href='관리자_게시판관리_FAQ(AdminBoardFaq).html'">FAQ</a>
						<a class="dropdown-item"
							onclick="location.href='관리자_게시판관리_일대일(AdminBoardOtO).html'">1:1게시판</a>
					</div>
				</div>
			</div>
			<div class="col">
				<div onclick="location.href='#';" class="dropdown"
					...
					<div class="dropdown-menu">
						<a class="dropdown-item"
							onclick="location.href='게시판 관리_설정_관리자정보수정.html'">관리자정보수정</a> <a
							class="dropdown-item" onclick="location.href='설정_관리자탈퇴.html'">관리자탈퇴</a>
					</div>
				</div>
			</div>
			...
			<form action="<%= request.getContextPath() %>/adminFaqUpdateForm.me" id="detailForm" method="post">
				<table class="table"
					...
					<tr>
						...
						<input type="text" size="35px" name="title"
							class="form-control" readonly value=<%=board.getBoardTitle()%>></td>
						<th scope="col">카테고리</th>
						<td width="30%">
							<select name="select" id="category" class="form-control" disabled>
				...
				<div class="col">
					<input type="button" class="button1"
						...
						value="돌아가기" style="margin-left: 300px; margin-right: 250px;">
