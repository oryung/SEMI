				...
				<table class="table"
					...
					<tbody>
						...
						<tr>
							...
							<td colspan="3"><input type="file"> <br> % 대표로
								확대이미지를 등록하면 다른 사이즈의 이미지들을 자동 생성합니다. % 이미지명은 영문, 숫자로만 사용하시기
								바랍니다.(한글, 공백, 특수문자 사용x)</td>
						</tr>
						<tr>
							<th scope="col" id="ie">상세이미지 등록</th>
							<td colspan="3"><input type='file'> <br> % 추가되는
								이미지는 상품상세정보 내 다른 이미지 보기에 사용됩니다.</td>
						</tr>
					</tbody>
				</table>
			</form>
