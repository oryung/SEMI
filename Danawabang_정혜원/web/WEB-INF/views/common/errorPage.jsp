...
h2{text-shadow: -1px 0 #97D7F7, 0 1px #97D7F7, 1px 0 #97D7F7, 0 -1px #97D7F7; }
</style>
</head>
<body style="font-family: 'Nanum Gothic', sans-serif;">
	...
	<div id="main-container" class="container">
		...
		<div class="row">
			<div class="col-12">
				<img src="images\errorPage_img.png"  style="width:100%; display: block; margin: 0px auto; ">
					<div class="row">
						<div class="col-12" style="margin-top:-130px;">
							<h2 align="center" style="color:#2E75C7; font-weight: bold; "><%= msg%></h2>
