...
<!--!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!상단!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!! -->
	<div id="main-container" class="container">
		...
		<div class="row" style="height: 580px;">
            ...
            <table class="table" style="width: 720px; margin-left: 220px; margin-top: 10px; text-align: center;">
				...
				<tr>
					...
					<td>healthy1</td>
					<td>활성화</td>
					<td onclick="location.href='게시판 관리_스토어 게시글 상세보기.html';" style="cursor:pointer;"><i class="bi bi-search"></i></td>
				</tr>
				<tr>
					<th scope="row"><input type="checkbox" class="check" name="agree" onclick="selectOne();"></th>
					<td>9</td>
		...
		<div class="row" style="height: 50px;">
			...
			<!-- 버튼 -->
			<div class="col" style="left: 27%;">
				<!-- 활성화 버튼 -->
				<button class="button1">활성화</button>
				<!-- 등록 버튼 -->
				<button class="button1" onclick="location.href='게시판 관리_스토어 게시글 등록.html'">등록</button>
				<!-- 삭제 버튼 -->
