	...
	<div id="main-container" class="container">
		...
		<div class="row" id="middleCategories">
			...
			<div onclick="location.href='주문 관리.html';" class="col"
				...
				주문 관리</div>
			<div  class="col">
				<div onclick="location.href='#';" class="dropdown" id="boardDropdown" data-toggle="dropdown"
					style="text-align: center; vertical-align: middle; text-decoration: none; cursor: pointer; font-size: 20px; font-weight: bold;">
					게시판 관리
			...
			<div class="col">
				<div onclick="location.href='#';"  class="dropdown" id="settingsDropdown" data-toggle="dropdown"
					style="text-align: center; vertical-align: middle; text-decoration: none; cursor: pointer; font-size: 20px; font-weight: bold;">
					설정
					<div class="dropdown-menu">
						<a class="dropdown-item" onclick="location.href='설정_관리자정보수정.html'">관리자정보수정</a>
